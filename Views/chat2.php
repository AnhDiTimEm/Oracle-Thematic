					...
					<div class="container">
						<div class="inside">
							<div class="nav nav-tab menu">
								<button class="btn"><img class="avatar-xl" src="./asset/img/avatars/avatar-male-1.jpg" alt="avatar"></button>
										...
										<div class="categories" id="accordionSettings">
											...
											<div class="category">
												...
												<div class="collapse" id="collapseOne" aria-labelledby="headingOne" data-parent="#accordionSettings">
													<div class="content">
														<div class="upload">
															<div class="data">
																<img class="avatar-xl" src="./asset/img/avatars/avatar-male-1.jpg" alt="image">
																<label>
																	<input type="file">
											...
											<div class="category">
												...
												<div class="collapse" id="collapseFour" aria-labelledby="headingFour" data-parent="#accordionSettings">
													<div class="content">
														<div class="app">
															<img src="./asset/img/integrations/slack.svg" alt="app">
														...
														<div class="app">
															<img src="./asset/img/integrations/dropbox.svg" alt="app">
															<div class="permissions">
																<h5>Dropbox</h5>
														...
														<div class="app">
															<img src="./asset/img/integrations/drive.svg" alt="app">
															<div class="permissions">
																<h5>Google Drive</h5>
														...
														<div class="app">
															<img src="./asset/img/integrations/trello.svg" alt="app">
															<div class="permissions">
																<h5>Trello</h5>
																<p>No permissions set</p>
															</div>
											...
											<div class="inside">
												<div class="panel">
													<div class="participant">
														<img class="avatar-xxl" src="./asset/img/avatars/avatar-female-5.jpg" alt="avatar">
							...
							<div class="chat" id="chat2">
								<div class="top">
									<div class="container">
										<div class="col-md-12">
											<div class="inside">
												<a href="#"><img class="avatar-md" src="./asset/img/avatars/avatar-female-2.jpg" data-toggle="tooltip" data-placement="top" title="Lean" alt="avatar"></a>
												<div class="status">
													<i class="material-icons offline">fiber_manual_record</i>
												</div>
												<div class="data">
